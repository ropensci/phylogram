...
as an increasing number of useful and convenient
bioinformatics packages become available. 
In particular, many sophisticated
tools have been developed for creating, editing, visualizing 
and publishing evolutionary trees within a suite of comprehensive 
packages such as **ape**, **phangorn** and **Phytools**. 
