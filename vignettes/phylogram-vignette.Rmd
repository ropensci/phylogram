...
--------------------------------------------------------------------------------
## Abstract
**Summary:** `phylogram` is an R package for developing evolutionary trees 
...
includes a suite of functions for rapidly computing distance matrices and 
...
sequence weighting, alignment guide trees, 
classification & regression trees, and phylogenetic 
analysis of very large biological sequence datasets.  
**Availability and Implementation:** The `phylogram` package is 
...
set.seed(999)
tree3 <- phylogram::topdown(woodmouse, k = 5, nstart = 5)
## sort nodes by size
...
We hope that this package will help biologists to 
further explore these exciting opportunities.  
